...
const Hero: React.FC = () => {
    return (
        <section id="hero" className="relative md:h-screen flex flex-col justify-center items-center my-20 md:my-0">
            <div className="flex flex-col justify-center items-center">
                <h1 className="uppercase mb-3 text-center text-xl text-white">About Me</h1>
                <h1 className="text-5xl md:text-6xl font-bold text-center mt-0">
                    Hi there, <br/> I'm Nolann <span className="text-[#C77DFF] drop-shadow-[0_0_15px_#C77DFF]">LESCOP</span>
                </h1>
                <p className="my-4 text-md text-center max-w-2xl">
                ...
                <div className="flex flex-col justify-center items-center mt-12 w-[40%]">
